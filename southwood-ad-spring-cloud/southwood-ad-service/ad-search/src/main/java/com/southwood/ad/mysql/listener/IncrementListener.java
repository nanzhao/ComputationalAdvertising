...
import com.southwood.ad.mysql.dto.TableTemplate;
...
/**
 * Created by nanzhao on 2019/2/11 10:39 AM
 */
@Slf4j
@Component
public class IncrementListener implements Ilistener {
    ...
    @Override
    @PostConstruct  //系统完成初始化的时候就立刻完成注册
    public void register() { //v是数据库名字，k是表名字
